            ...
            <div className={`w-full max-w-[66rem] h-[26rem] flex flex-col rounded-[2.5rem] relative ${isDark ? 'bg-[#3b4356] shadow-[inset_0_1px_2px_rgba(255,255,255,0.1),0_20px_40px_rgba(0,0,0,0.4)] border border-white/5' : 'bg-gray-100 border border-gray-300 shadow-lg'}`}>
                ...
                <div className="flex-1 flex items-center justify-center pt-8">
                    ...
                    <div className="flex items-center pr-[4.5rem]">
                        ...
                        <div className="mr-14">
                            <div className={`w-[6.5rem] h-[6.5rem] rounded-full flex items-center justify-center ${isDark ? 'bg-[#363d4f] text-[#8b9cb0] shadow-[-5px_-5px_12px_rgba(255,255,255,0.03),5px_5px_15px_rgba(0,0,0,0.4)] border border-white/5 hover:text-white transition-colors cursor-pointer' : 'bg-gray-100 border-2 border-gray-300 shadow-xl cursor-pointer hover:bg-gray-200'}`}>

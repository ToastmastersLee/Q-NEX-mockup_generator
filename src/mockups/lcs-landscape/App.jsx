                  ...
                  {currentLayout === 'l5' && (
                    <div className="lcs-split-screen">
                      {(() => {
                        ...
                        return (
                          <>
                            <div className="lcs-split-left-col" style={{ display: 'grid', gridTemplateRows: '1fr 1fr', gap: '4px', height: '100%', boxSizing: 'border-box' }}>
                  ...
                  {currentLayout === 'l6' && (
                    <div className="lcs-split-screen lcs-layout-l6">
                      {(() => {
                        ...
                        return (
                          <>
                            <div className="lcs-split-left-col lcs-three-rows" style={{ display: 'grid', gridTemplateRows: '1fr 1fr 1fr', gap: '4px', height: '100%', boxSizing: 'border-box' }}>
                              <div className="lcs-split-small-box">
